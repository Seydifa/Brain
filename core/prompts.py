...
QA_SYSTEM = SystemMessage(
    content=(
        ...
        "  1. Prefer the provided context. Use knowledge chunks as your primary "
        "source and cite them as [1], [2], etc.\n"
        "  1b. When NO knowledge chunks are available (context shows "
        "'No context available' or empty relevant_knowledge), answer directly "
        "from your general training knowledge. Preface with a brief note: "
        "'*(Answered from general knowledge — no verified sources in memory "
        "for this topic yet.)*'\n"
        "  2. If even general knowledge is insufficient, say explicitly: "
