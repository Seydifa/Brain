...
ACTION_AGENT_SYSTEM = SystemMessage(
    content=(
        ...
        "By action_type:\n"
        "  run_code:\n"
        "    1. Write minimal code to address the goal.\n"
        "    2. Execute with execute_python tool.\n"
        "    3. Report stdout/stderr + check each actionable_fact.\n"
        "  validate:\n"
        "    1. Identify claims. Use execute_python if verifiable with code.\n"
        "    2. Report CONFIRMED / REFUTED / UNKNOWN per fact.\n"
        "  check_env:\n"
        "    1. Run minimal environment check.\n"
        "    2. Report versions, packages, config values.\n\n"
        ...
        "  SOLUTION:\n"
        "  <final working code, only on STATUS: success>\n\n"
        "Safety:\n"
