...
MEMORY_CLASSIFY_SYSTEM = SystemMessage(
    content=(
        ...
        "Decision rules:\n"
        "  1. Only classify as follow_up / elaboration / clarification / correction "
        "if you can point to a specific episode_id from the history.\n"
        "  2. If the subject matter shifts even slightly, prefer new_topic.\n"
        "  3. Do not invent connections that are not clearly present.\n\n"
